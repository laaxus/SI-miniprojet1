...
fig1 = plt.figure()
plt.errorbar(np.arange(1,9,1),pc[0], yerr = pc[1], capsize = 3, barsabove = True, label = 'Posix Implementation')
...
fig2 = plt.figure()
plt.errorbar(np.arange(1,9,1),rw[0], yerr = rw[1], capsize = 3, barsabove = True, label = 'Posix Implementation')
...
fig3 = plt.figure()
plt.errorbar(np.arange(1,9,1),ph[0], yerr = ph[1], capsize = 3, barsabove = True, label = 'Posix Implementation')
